...
/* https://api.open-meteo.com/v1/forecast?hourly=temperature_2m,apparent_temperature,precipitation_probability,weathercode,windspeed_10m&daily=weathercode,temperature_2m_max,temperature_2m_min,apparent_temperature_max,precipitation_sum&current_weather=true&windspeed_unit=mph&precipitation_unit=inch&timeformat=unixtime
 */
...
function ParseCurrentWeather({ current_weather, daily }) {
  ...
  return {
    ...
    highFeelsLike: Math.floor(maxFeelsLike),
    lowFeelsLike: Math.floor(minFeelsLike),
    windSpeed: Math.floor(windSpeed),
    precip: Math.floor(precip * 100) / 100,
    iconCode: iconCode,
  };
}
